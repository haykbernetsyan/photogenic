        ...
        <div class="container" id="contact">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>
                        <span class="email"><img src="/wordpress/wp-content/uploads/2020/06/email.png"
                                alt="email icon" /></span><b>contact@example.com</b>
                    </p>
                    <p>
                        <span class="phone"><img src="/wordpress/wp-content/uploads/2020/06/phone.png" alt="phone icon" /></span><b>+123-456-7890</b>
                    </p>
                    <h3>We Are Social:</h3>
